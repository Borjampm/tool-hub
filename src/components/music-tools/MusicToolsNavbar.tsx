...
interface MusicToolsNavbarProps {
  activeTab: 'metronome' | 'reading';
  onTabChange: (tab: 'metronome' | 'reading') => void;
}

export function MusicToolsNavbar({ activeTab, onTabChange }: MusicToolsNavbarProps) {
  ...
  const handleTabChange = (tab: 'metronome' | 'reading') => {
    onTabChange(tab);
  ...
  const navigationItems = [
    ...
    { id: 'reading' as const, label: 'Reading Practice' },
  ];
            ...
            {user && (
              <>
                <button
                  ...
                  className="text-sm text-gray-600 hover:text-purple-600 hover:underline truncate max-w-32 lg:max-w-48 transition-colors duration-200 cursor-pointer"
            ...
            <div className="pt-2 pb-3 space-y-1">
              ...
              {user && (
                <div className="border-t border-gray-200 pt-3 mt-3">
                  <button
                    onClick={handleAccountClick}
                    className="block w-full text-left px-3 py-2 text-sm text-gray-600 hover:text-purple-600 hover:bg-gray-50 truncate transition-colors duration-200 touch-manipulation min-h-[44px]"
